...
import { Button, Container, Div, Input } from '@/index';
...
import countrySelectStyles from '@/shared/styles/selectsStyles/CountrySelect';

import { UserDetailsFieldsProps } from '@/shared/interfaces/UserDetailsInterface';
