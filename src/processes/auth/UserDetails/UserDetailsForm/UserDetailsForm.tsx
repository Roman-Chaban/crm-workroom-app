...
import { UserDetailsMessage, Container, UserDetailsFields, SignInNav, Form } from '@/index';

import { toast } from 'react-hot-toast';

import { registerUser } from '@/entities/api/registration';
...
interface SingInNavClassNames {
  container: string;
  nextBtn: string;
}

const signInNavClassNames: SingInNavClassNames = {
  ...
  return (
    ...
    >
      ...
      <SignInNav
        ...
        classNames={signInNavClassNames}
      />
    </Form>
  );
};
